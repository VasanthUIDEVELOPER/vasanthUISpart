document.addEventListener('DOMContentLoaded', () => {
    ...
    for (let i = 0; i < square.length; i++) {
        square[i].onclick = () => {
            // console.log(square[i])
            if (square[i + 7].classList.contains('taken') && !
                square[i].classList.contains('taken')) {
                if (currentplayer == 1) {
            ...
            else if (square[i + 7].classList.contains('taken')) {
                square[i].classList.add('taken')
                displaycurrentplayer.innerHTML = currentplayer
            }
            else {
...
function drawn(){
if(document.querySelectorAll('.grid div')== square.classList.contains('player-one')){
    return
}
else if(document.querySelectorAll('.grid div')==square.classList.contains('player-two')){
    return
}
else{
    result.innerHTML='Draw'
